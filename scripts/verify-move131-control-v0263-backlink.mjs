...
const receipt = JSON.parse(
  fs.readFileSync("integrations/control/ANTIMATTERIUM_CORE_MOVE131_CONTROL_V0263_BACKLINK.json", 'utf8')
);
...
const expected = {
  ...
  "packageTag": "v0.2.78-antimatterium-control-v0263-backlink",
  "packageRelease": "https://github.com/ANTIMATTERIUM/ANTIMATTERIUM/releases/tag/v0.2.78-antimatterium-control-v0263-backlink",
  "controlVersion": "0.2.63",
  "controlTag": "v0.2.63-antimatterium-control-move129-surface-closure",
  "controlRelease": "https://github.com/ANTIMATTERIUM/CONTROL/releases/tag/v0.2.63-antimatterium-control-move129-surface-closure",
  "controlCi": "https://github.com/ANTIMATTERIUM/CONTROL/actions/runs/29206398893",
  "controlSha": "afada789807ee3333e6c45a6f29aff5790d5ea05",
  "controlClosureId": "94889ea04b57855f99f8cff464dc287b3ca518a9f0d38732dd3adc7e26040c05",
  "backlinkId": "7ec19076c167c3a4a19ecd21731493ecfc5ddba72fca93b8fb7e61e3ae164fca"
};
const outputPrefix = "ANTIMATTERIUM_CORE_MOVE131_CONTROL_V0263_BACKLINK";
...
const checks = [
  ...
  ['membership.member_of_move131_surface_fanout', receipt.membership?.member_of_move131_surface_fanout, true],
  ['membership.control_v0263_release_bound', receipt.membership?.control_v0263_release_bound, true],
...
if (recomputed !== receipt.backlink_id) {
  fail(
    'MOVE131_BACKLINK_ID_RECOMPUTE_FAILED expected ' +
    receipt.backlink_id +
    ', got ' +
    recomputed
  );
...
console.log(outputPrefix + '_CONTROL_V0263_RELEASE_BOUND=true');
console.log(outputPrefix + '_CONTROL_V0263_MEMBER=true');
