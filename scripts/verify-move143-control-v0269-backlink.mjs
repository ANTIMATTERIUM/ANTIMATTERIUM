...
const receipt = JSON.parse(
  fs.readFileSync("integrations/control/ANTIMATTERIUM_CORE_MOVE143_CONTROL_V0269_BACKLINK.json", 'utf8')
);
...
const expected = {
  ...
  "move": 123,
  "surface": "core",
  "packageVersion": "0.2.84",
  "packageTag": "v0.2.84-antimatterium-control-v0269-backlink",
  "packageRelease": "https://github.com/ANTIMATTERIUM/ANTIMATTERIUM/releases/tag/v0.2.84-antimatterium-control-v0269-backlink",
  ...
  "backlinkId": "3e61d04f6514637200f25fc2386185996173a3431f16e78e841fbf03bd383c14"
};
const outputPrefix = "ANTIMATTERIUM_CORE_MOVE143_CONTROL_V0269_BACKLINK";
