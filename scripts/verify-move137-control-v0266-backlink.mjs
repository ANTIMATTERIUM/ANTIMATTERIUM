...
const receipt = JSON.parse(
  fs.readFileSync("integrations/control/ANTIMATTERIUM_CORE_MOVE137_CONTROL_V0266_BACKLINK.json", 'utf8')
);
...
const expected = {
  ...
  "packageTag": "v0.2.81-antimatterium-control-v0266-backlink",
  "packageRelease": "https://github.com/ANTIMATTERIUM/ANTIMATTERIUM/releases/tag/v0.2.81-antimatterium-control-v0266-backlink",
  ...
  "backlinkId": "639f86df6ccd79826c36d0fe9ffa2cc00571e878c1f6f81101ac6fba476cdfaf"
};
const outputPrefix = "ANTIMATTERIUM_CORE_MOVE137_CONTROL_V0266_BACKLINK";
