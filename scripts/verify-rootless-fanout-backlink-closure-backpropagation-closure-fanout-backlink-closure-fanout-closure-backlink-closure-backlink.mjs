...
const receipt = JSON.parse(fs.readFileSync(new URL("../integrations/control/ANTIMATTERIUM_CORE_ROOTLESS_FANOUT_BACKLINK_CLOSURE_BACKPROPAGATION_CLOSURE_FANOUT_BACKLINK_CLOSURE_FANOUT_CLOSURE_BACKLINK_CLOSURE_BACKLINK.json", import.meta.url), "utf8"));
const pkg = JSON.parse(fs.readFileSync(new URL("../package.json", import.meta.url), "utf8"));

assert(pkg.version === "0.2.25", "package version mismatch");
assert(receipt.package.version === "0.2.25", "receipt package version mismatch");
...
console.log("CORE3" + "_VERIFY_PASS=true");
console.log("CORE3" + "_CONTROL_V0210_RELEASE_BOUND=true");
console.log("CORE3" + "_CONTROL_V0210_MEMBER=true");
console.log("ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true");
console.log("CORE4" + "=" + receipt.closure_id);
