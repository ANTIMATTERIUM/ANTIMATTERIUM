...
const receipt = JSON.parse(fs.readFileSync(new URL('../integrations/control/ANTIMATTERIUM_CORE_MOVE43_CONTROL_V0219_BACKLINK.json', import.meta.url), 'utf8'));
const pkg = JSON.parse(fs.readFileSync(new URL('../package.json', import.meta.url), 'utf8'));

test('Core binds CONTROL v0.2.19 public closure', () => {
  assert.equal(pkg.name, '@antimatterium/antimatterium');
  assert.equal(pkg.version, '0.2.34');
  assert.equal(receipt.package_name, '@antimatterium/antimatterium');
  assert.equal(receipt.package_version, '0.2.34');
  ...
  assert.equal(receipt.backlink_id, '030604066e720daecb36c2e43a7cfe70e7f763b69f2766241f8277b058342d6a');
  assert.equal(receipt.CORE_MOVE43_CONTROL_V0219_BACKLINK_ID, '030604066e720daecb36c2e43a7cfe70e7f763b69f2766241f8277b058342d6a');

  console.log('ANTIMATTERIUM_CORE_MOVE43_CONTROL_V0219_BACKLINK_VERIFY_PASS=true');
  console.log('ANTIMATTERIUM_CORE_CONTROL_V0219_RELEASE_BOUND=true');
  console.log('ANTIMATTERIUM_CORE_CONTROL_V0219_MEMBER=true');
  console.log('ANTIMATTERIUM_SHORT_PUBLIC_TAG_REQUIRED=true');
  console.log('ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true');
  console.log('CORE_MOVE43_CONTROL_V0219_BACKLINK_ID=030604066e720daecb36c2e43a7cfe70e7f763b69f2766241f8277b058342d6a');
