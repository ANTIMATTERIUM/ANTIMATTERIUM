...
const receipt = JSON.parse(
  fs.readFileSync("integrations/control/ANTIMATTERIUM_CORE_MOVE135_CONTROL_V0265_BACKLINK.json", 'utf8')
);
...
const expected = {
  ...
  "move": 123,
  "surface": "core",
  "packageVersion": "0.2.80",
  "packageTag": "v0.2.80-antimatterium-control-v0265-backlink",
  "packageRelease": "https://github.com/ANTIMATTERIUM/ANTIMATTERIUM/releases/tag/v0.2.80-antimatterium-control-v0265-backlink",
  ...
  "backlinkId": "abb30f6f935d6c939237154b47e8966121bf8f9c506353a45aa0e7f2c4616da2"
};
const outputPrefix = "ANTIMATTERIUM_CORE_MOVE135_CONTROL_V0265_BACKLINK";
