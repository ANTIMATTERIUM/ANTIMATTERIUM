...
const receiptPath = new URL("../integrations/control/ANTIMATTERIUM_CORE_ROOTLESS_FANOUT_BACKLINK_CLOSURE_BACKPROPAGATION_CLOSURE_FANOUT_CLOSURE_BACKLINK.json", import.meta.url);
const receipt = JSON.parse(fs.readFileSync(receiptPath, "utf8"));
const pkg = JSON.parse(fs.readFileSync(new URL("../package.json", import.meta.url), "utf8"));

const id = receipt.core_rootless_fanout_backlink_closure_backpropagation_closure_fanout_closure_backlink_id;
const clone = { ...receipt };
delete clone.core_rootless_fanout_backlink_closure_backpropagation_closure_fanout_closure_backlink_id;

assert(pkg.name === "@antimatterium/antimatterium", "package name mismatch");
assert(pkg.version === "0.2.22", "package version mismatch");
...
assert(receipt.core_rootless_fanout_backlink_closure_backpropagation_closure_backlink_id === "42b2cc4852eae0a29b81f328919684c9e83a661bf502c7d9b03087ff577eeb6a", "prior backlink id mismatch");
assert(receipt.package_name === "@antimatterium/antimatterium", "receipt package name mismatch");
assert(receipt.package_version === "0.2.22", "receipt package version mismatch");
...
console.log("ANTIMATTERIUM_CORE_ROOTLESS_FANOUT_BACKLINK_CLOSURE_BACKPROPAGATION_CLOSURE_FANOUT_CLOSURE_BACKLINK_VERIFY_PASS=true");
console.log("ANTIMATTERIUM_CORE_CONTROL_V027_RELEASE_BOUND=true");
console.log("ANTIMATTERIUM_CORE_ROOTLESS_FANOUT_BACKLINK_CLOSURE_BACKPROPAGATION_CLOSURE_FANOUT_CLOSURE_MEMBER=true");
console.log("ANTIMATTERIUM_NO_LOCAL_ROOT_REQUIRED=true");
console.log("CORE_ROOTLESS_FANOUT_BACKLINK_CLOSURE_BACKPROPAGATION_CLOSURE_FANOUT_CLOSURE_BACKLINK_ID=" + id);
